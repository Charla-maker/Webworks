          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {locationsData.map((area) => (
              <Link
                ...
                className="text-left bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100 group"
              >
